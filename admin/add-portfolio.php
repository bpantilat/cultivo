                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tags" class="form-control" value="Prototyping, Colorado Media Porject" id="tag" required="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputTitle1">Bold Title</label>
                      <textarea name="" maxlength="200" minlength="200" maxlength="160" minlength="160" id="bold_title" cols="30" rows="4" class="form-control" required=""></textarea>
                    </div>
...
<script src="js/tagify.js"></script>
  ...
  <script src="js/add-portfolio.js"></script>